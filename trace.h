...
DESCRIPTION
       The <trace.h> header shall define the posix_trace_event_info structure, which shall include at least the following members:
       ...
       The <trace.h> header shall define the posix_trace_status_info structure, which shall include at least the following members:
       ...
       The <trace.h> header shall define the size_t, trace_attr_t, trace_event_id_t, trace_event_set_t, and trace_id_t types as described in <sys/types.h>.
...
SEE ALSO
       ...
       The System Interfaces volume of POSIX.1‐2017, Section 2.11, Tracing, posix_trace_attr_destroy(), posix_trace_attr_getclockres(), posix_trace_attr_getinherited(), posix_trace_attr_getlogsize(),
       posix_trace_clear(), posix_trace_close(), posix_trace_create(), posix_trace_event(), posix_trace_eventid_equal(), posix_trace_eventset_add(), posix_trace_eventtypelist_getnext_id(),
       posix_trace_get_attr(), posix_trace_get_filter(), posix_trace_getnext_event(), posix_trace_start()
