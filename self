...
DESCRIPTION
       ...
       self call
              ...
              from within constructors and destructors, whose  names  are  re‐
              ported  as <constructor> and <destructor> respectively), and the
       ...
       self caller
              ...
              the name of the object on which the containing  method  was  in‐
              voked, and the third element is the name of the method (with the
              strings <constructor> and <destructor>  indicating  constructors
       ...
       self filter
              ...
              implementation  of the filter), the second element is either ob‐
              ject or class depending on whether the declaring entity  was  an
              object  or  class, and the third element is the name of the fil‐
              ter.

       self method
              This returns the name of the current method  (with  the  strings
              <constructor>  and  <destructor> indicating constructors and de‐
       ...
       self next
              ...
              implementation),  this subcommand returns a two element list de‐
              scribing the next element in the method call  chain;  the  first
              ...
              indicating constructors and destructors  respectively).  If  in‐
              voked  from  a  method  that is at the end of a call chain, this
       ...
       self target
              When invoked inside a filter implementation, this subcommand re‐
              turns a two element list describing the method  being  filtered.
